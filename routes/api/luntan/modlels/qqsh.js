 ...
 */
/**
 * @api {post} /api/luntan/qqsh/index 琴棋书画版块
 * @apiName qqshI
* @apiGroup test
    * @apiDescription  论坛琴棋书画版块，进入论坛首页后，会显示五个版块的10条点击率高的数据，此接口是获取琴棋书画板块点击率高的
    * @apiParam {string} types 类型(qqsh)
...
/**
 * @api {post} /api/luntan/qqsh/list 琴棋书画列表版块
 * @apiName qqshL
* @apiGroup test
    * @apiDescription  论坛琴棋书画所有列表版块 ，点击论坛首页琴棋书画板块后，会显示所有列表数据，此接口是获取所有列表数据
    * @apiParam {string} types 类型(qin,qi,shu,hua)
    ...
    */
/**
 * @api {post} /api/luntan/qqsh/details 琴棋书画详情页版块
 * @apiName qqshD
    * @apiGroup test
    * @apiDescription  论坛琴棋书画详情页版块
