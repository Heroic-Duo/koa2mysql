 ...
 */
/**
 * @api {post} /api/luntan/zhongYang/index 中养版块
 * @apiName zhongYangI
* @apiGroup test
    * @apiDescription  论坛中养版块 ，进入论坛首页后，会显示五个版块的10条点击率高的数据，此接口是获取中养板块点击率高的
    * @apiParam {string} types 类型(zhongyang)
...
/**
 * @api {post} /api/luntan/zhongYang/list 中养列表版块
 * @apiName zhongYangL
* @apiGroup test
    * @apiDescription  论坛中养所有列表版块 ，点击论坛首页中养板块后，会显示所有列表数据，此接口是获取所有列表数据
    * @apiParam {string} types 类型(siji,neijing)
    ...
    */
/**
 * @api {post} /api/luntan/zhongYang/details 中养详情页版块
 * @apiName zhongYangD
    * @apiGroup test
    * @apiDescription  论坛中养详情页版块
