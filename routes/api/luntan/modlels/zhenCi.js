 ...
 */
/**
 * @api {post} /api/luntan/zhenCi/index 痧罐针灸版块
 * @apiName zhenCiX
* @apiGroup test
    * @apiDescription  论坛罐针灸版块 ，进入论坛首页后，会显示五个版块的10条点击率高的数据，此接口是获取罐针灸板块点击率高的
    * @apiParam {string} types 类型(zhenci)
...
/**
 * @api {post} /api/luntan/zhenCi/list 罐针灸列表版块
 * @apiName zhenCiL
* @apiGroup test
    * @apiDescription  论坛罐针灸所有列表版块 ，点击论坛首页罐针灸板块后，会显示所有列表数据，此接口是获取所有列表数据
    * @apiParam {string} types 类型(guasha,huoguan,zhenci,aijiu)
    ...
    */
/**
 * @api {post} /api/luntan/zhenCi/details 罐针灸详情页版块
 * @apiName zhenCiD
    * @apiGroup test
    * @apiDescription  论坛罐针灸详情页版块
