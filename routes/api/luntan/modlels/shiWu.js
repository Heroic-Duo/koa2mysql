 ...
 */
/**
 * @api {post} /api/luntan/shiWu/index 食疗食谱版块
 * @apiName shiWuI
* @apiGroup test
    * @apiDescription  论坛食疗食谱版块，进入论坛首页后，会显示五个版块的10条点击率高的数据，此接口是获取食疗食谱板块点击率高的
    * @apiParam {string} types 类型(shiwu)
...
/**
 * @api {post} /api/luntan/shiWu/list 食疗食谱列表版块
 * @apiName shiWuL
* @apiGroup test
    * @apiDescription  论坛食疗食谱所有列表版块 ，点击论坛首页食疗食谱板块后，会显示所有列表数据，此接口是获取所有列表数据
    * @apiParam {string} types 类型(shiliao,shipu)
    ...
    */
/**
 * @api {post} /api/luntan/shiWu/details 食疗食谱详情页版块
 * @apiName shiWuD
    * @apiGroup test
    * @apiDescription  论坛食疗食谱详情页版块
